        ...
        <div class="list-group">
            ...
            <div class="list-group-item unread">
                <div class="list-left">
                    ...
                    <a href="view_Selected_messages<?php echo $row->id; ?>"><span class="markstar"><i class="glyphicon glyphicon-star"></i></span>
                </div>
                <div class="media">
                    ...
                    </div><a href=""><span class="pull-right"><i class="fa fa-trash"></i></span></a>
                    {{--
