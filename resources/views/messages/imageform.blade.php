        ...
        <div class="col-md-6">
            <div class="panel">
                ...
                <div class="panel-body">
                    ...
                    <form id="basicForm" class="form-horizontal" action="{{ URL::to('upload') }}" method="post"
                        ...
                        <div class="form-group">
                            <label class="col-sm-3 control-label">Choose Image <span
                        ...
                        <a href="editUploadImage"><input type="button" class="btn btn-success btn-quirk btn-wide mr5"
                                                         value="Edit"></a>
