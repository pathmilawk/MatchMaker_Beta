    ...
    <div class="col-md-12">
        <div class="panel">
            ...
            <div class="panel-body">
                <hr>
                <form id="basicForm" action="mingleSenMessage" method="post" class="form-horizontal">
                    ...
                    <div class="form-group">
                        <label class="col-sm-3 control-label">Name <span class="text-danger">*</span></label>
                        <div class="col-sm-8">
                            <select id="name" class="select2" name="name" style="width: 100%" data-placeholder="Choose One" required>
                                <option value="">&nbsp;</option>
