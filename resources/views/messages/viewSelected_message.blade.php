...
@section('content')
    ...
    <hr>
    <button type="button" class="btn btn-info btn-lg" data-toggle="modal" data-target="#myModal" style="margin-left: 10px">View Message</button>
            ...
            <div class="panel panel-primary">
                ...
                <div id="collapseThree3" class="panel-collapse collapse">
                    <div class="panel-body">
                        ...
                        <hr>
                        <input type="button" class="btn btn-info btn-lg" name="send" value="Send"></button>                    </div>
                </div>
            </div>
        </div>
    </div><!-- col-md-4 -->
