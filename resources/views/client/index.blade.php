    ...
    <div class="banner">
        <div class="logo">
            ...
            <div class="searchBox">
                ...
                <form id="searchBox" action="{{URL::to('register')}}"; method="POST">
                    <input type="hidden" name="_token" value="{{ csrf_token() }}">
                    <table name="searchBox_table" style="margin-top: 20px; margin-left: 30px; margin-right: 30px">
                        <tr>
                            <td>I am a </td>
                            <td>
                                <select name="usersGender" data-placeholder = 'Gender'>
                            ...
                            <td>looking for a</td>
                            <td>
                                <select name="lookingGender" data-placeholder = 'Gender'>
                                    <option value="">Gender</option>
                                    <option>Male</option>
                                    <option>Female</option>
                                </select>
                        ...
                        <tr>
                            <td>From</td>
                            <td>
                                <select name="places" data-placeholder = 'Select a District'>
                        ...
                        <tr>
                            <td>Age</td>
                            <td>
                                <select name="ageStart" data-placeholder = 'Minimum Age'>
                            ...
                            <td>to</td>
                            <td>
                                <select name="ageEnd" data-placeholder = 'Maximum Age'>
                        ...
                        <tr>
                            <td>Mother Tongue</td>
                            <td>
                                <select name="motherTongue" data-placeholder="Select a Language">
...
{{--
            <div class="serve-top">
--}}
                <div class="col-md-12 serve-section grid">
...
@section('js_ref')
    ...
    //savidya's java script

    {{--<script type='text/javascript'>

        function SubmitForm()
        {
            if(document.forms['searchBox'].onsubmit())
            {

                document.forms['searchBox'].action='action1.php';
                document.forms['searchBox'].submit();

                document.forms['searchBox'].action='action2.php';
                document.forms['searchBox'].submit();
            }
            return true;
        }
