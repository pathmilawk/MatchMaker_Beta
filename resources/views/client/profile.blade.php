        ...
        <div class="row profile-wrapper">
            <div class="col-xs-12 col-md-3 col-lg-2 profile-left">
                <div class="profile-left-heading">
                    ...
                    @else
                        <button class="btn btn-danger btn-quirk btn-block profile-btn-follow" id="sendReq" onclick="sendRequest({{$key->user_id}})">Send Request</button>
                    @endif
                    ...
                    <div class="col-sm-6 col-md-12">
                        <div class="panel">
                            <div class="panel-heading">
                                <h4 class="panel-title">Interested People</h4>
                            </div>
                            <div class="panel-body" id="interest">
                                <div class="panel" style="align-content: center;">
                                    <button style="margin: 10px; margin-left:60px;" class="btn btn-primary" value="View Interested People" onclick="interests({{$key->user_id}})">View Interested People</button>
                                    {{--content will load using ajax--}}
                                </div>
                            </div>
                        </div><!-- panel -->
                    </div>
        ...
        function interests(id)
        {
            $.ajax({
                ...
                success: function (data) {
                    document.getElementById("interest").innerHTML = data;
                },
                error: function (err) {
                    alert(err);
                },
