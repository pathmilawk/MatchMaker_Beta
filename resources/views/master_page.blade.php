...
<head>
  ...
  @section('css_ref')
    ...
    <link rel="stylesheet" href="{{asset('internal_css/lib/bootstrap/css/boostrap.min..css')}}">
        ...
        <ul class="headermenu">
          <li>
            <div id="noticePanel" class="btn-group">
              <a href="startmingle"><button type="button" class="glyphicon glyphicon-glass" style="margin-top: 20px;color: red">

              </button></a>
              <div id="noticeDropdownm" >
                <div role="">
                  <!-- Nav tabs -->
...
--}}
                  ...
                  <div class="tab-content">
                    <div role="tabpanel" class="" id="notification">
                      <ul class="">
