    ...
    <div class="col-sm-6">
        <div class="panel">
            ...
            <div class="panel-body nopaddingtop">
                <hr>
                <form action="http://<?php echo $_SERVER['SERVER_NAME']; ?>/addinfo" method="POST" id="basicForm" class="form-horizontal">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <select id="country" name="country" class="select2" style="width: 100%" data-placeholder="choose country">
                                <option value="">&nbsp;</option>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <input type="text" name="telephone_mobile" class="form-control" placeholder="telephone mobile">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <input type="text" name="telephone_home" class="form-control" placeholder="telephone home">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <input type="text" name="telephone_work" class="form-control" placeholder="telephone work">
                        </div>
                    </div>
